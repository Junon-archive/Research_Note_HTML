...
## 0. 논문 한눈에 보기
- 제목: Accel-Sim: An Extensible Simulation Framework for Validated GPU Modeling (이하 Accel-sim)
...
- ISA Def 파일에서 이 유닛을 사용하는 machine ISA op code를 매핑해야됨 (주의!! 새로운 ISA 만들라는 뜻이 아님!!)
